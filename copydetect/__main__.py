...
def main():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="don't compare files located in the same " "leaf directory",
    )
    parser.add_argument(
        "-f",
        "--disable-filter",
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="truncate non-copied portions of highlighted " "code",
    )
    parser.add_argument(
        "-O",
        "--out-file",
    ...
    if args.conf:
        ...
        parser.error(
            "either a path to a configuration file (-c) or a "
